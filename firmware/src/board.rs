...
// Interrupt bindings: USB + flash DMA + TRNG + SPI DMA. All DMA channels
// share DMA_IRQ_0 on RP235x; the generated ISR dispatches to each listed
// handler, which filters by its own channel bit. DMA_CH2 = flash owner,
// DMA_CH0/CH1 = SPI0 TX/RX when `feature = "radio"` is enabled.
